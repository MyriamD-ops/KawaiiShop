    ...
    <main class="container mx-auto px-4 py-8">
        ...
        <div class="flex flex-col md:flex-row justify-between items-start md:items-center mb-6">
            <div>
                ...
                <p class="text-gray-600 mt-1">Gérez les catégories de votre boutique</p>
            </div>
            <a href="{{ route('categories.create') }}" 
               class="mt-4 md:mt-0 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg font-medium transition flex items-center">
